package com.kiranshinde.restservices.exceptions;
...
public class CustomGlobalExceptionHandler extends ResponseEntityExceptionHandler{
	...
	// MethodArgumentNotValidException
		...
		// MethodArgumentTypeMismatchException
				...
				public final ResponseEntity<Object> handleMethodArgumentTypeMismatchException(ConstraintViolationException ex,
						WebRequest request) {
					CustomErrorDetails customErrorDetails = new CustomErrorDetails(new Date(), ex.getMessage(),
							request.getDescription(false));
